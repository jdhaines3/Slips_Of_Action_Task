...
Public Class EndBlockTrain
    ...
    Private Sub BeginBlock_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        sr.WriteLine(stimType & "," & stimType & "," & stimType & "," & stimType & "," & stimType)
        sr.Close()
        fs.Close()
    ...
    Private Sub BeginBlock_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
