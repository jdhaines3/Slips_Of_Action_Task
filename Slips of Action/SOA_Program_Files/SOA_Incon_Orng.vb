...
Public Class SOA_Incon_Orng
    ...
    Private Sub OrngSOA_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'get functions to set variables pulled from frmMain
        d1 = frmMain.getD1()
        d2 = frmMain.getD2()
    ...
    Private Sub OrngSOA_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
        ...
        ElseIf e.KeyChar = "2" Then
            ...
            'if stim deval'd, subtract points and set pic/resp to "incorrect go"
